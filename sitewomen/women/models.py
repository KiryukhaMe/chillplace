...
class Women(models.Model):
    ...
    cat = models.ForeignKey('Category', on_delete=models.PROTECT, related_name='posts', verbose_name='Категории') # posts для обратной связи (изнач. women_set)
    ...
    objects = models.Manager() # Базовый менеджер запросов
